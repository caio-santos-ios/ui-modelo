  ...
  return (
    <header className="sticky top-0 flex flex-col w-full bg-white border-gray-200 z-1 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        <div className={`${isApplicationMenuOpen ? "flex" : "hidden"} flex-col lg:flex-row lg:items-center justify-between w-full gap-4 px-1 py-4 lg:px-6 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none`}>
